...
where
    DL: CellDataProvider + HeaderProvider + EpochProvider + Clone + Send + Sync + 'static,
{
...
impl<'a, DL: 'static + HeaderProvider + CellDataProvider + EpochProvider + Clone + Send + Sync>
...
impl<'a, DL: CellDataProvider + HeaderProvider + EpochProvider + Clone + Send + Sync + 'static>
    FeeCalculator<'a, DL>
{
    fn new(
        transaction: &'a ResolvedTransaction,
...
impl<DL: CellDataProvider + HeaderProvider + Clone + Send + Sync + 'static> ScriptVerifier<DL> {
