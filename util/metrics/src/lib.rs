...
static METRICS: once_cell::sync::Lazy<Metrics> = once_cell::sync::Lazy::new(|| {
    Metrics {
        ckb_chain_tip: register_int_gauge!("ckb_chain_tip", "The CKB chain tip header number")
            .unwrap(),
        ...
        ckb_freezer_read: register_int_counter!("ckb_freezer_read", "The CKB freezer read")
            .unwrap(),
        ...
        ckb_message_bytes: register_histogram_vec!(
            ...
            vec![
                500.0, 1000.0, 2000.0, 5000.0, 10000.0, 20000.0, 50000.0, 100000.0, 200000.0,
                500000.0
            ]
        )
        .unwrap(),
