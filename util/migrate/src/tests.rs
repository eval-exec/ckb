...
use ckb_db::RocksDB;
use ckb_db_schema::{
    COLUMN_BLOCK_BODY, COLUMN_BLOCK_EPOCH, COLUMN_BLOCK_EXT,
    COLUMN_BLOCK_HEADER, COLUMN_BLOCK_PROPOSAL_IDS, COLUMN_BLOCK_UNCLE, COLUMN_EPOCH, COLUMN_INDEX,
    COLUMN_META
};
...
fn test_mock_migration() {
    ...
    // insert block
    {
        ...
        db_txn
            ...
            .unwrap();
        db_txn
            .put(COLUMN_BLOCK_HEADER::NAME, hash.as_slice(), header.as_slice())
            .unwrap();
        db_txn
